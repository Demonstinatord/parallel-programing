...
## Цель работы
Запустить параллельную версию программы умножения матриц (MPI) на суперкомпьютере «Сергей Королёв», провести эксперименты с разным количеством процессов (1, 2, 4, 8, 10) и разными размерами матриц (200, 400, 800, 1200, 1600, 2000).
