...
![Верификация](images/opencl_ver.jpg)
...
![График времени выполнения](images/cuda_graph.jpg)
...
- Папка results_xx/ с результатами экспериментов
- Файл results_xx/results.csv с таблицей времени выполнения
